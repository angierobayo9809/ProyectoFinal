                    ...
                    <div class="card-body">
                        <form action="update.php" method="POST" name="forrol">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="eps" name="eps" value="<?= $estud_eps ?>">
                            </div>

                            <div class="form-group">
                                <label for="tipoSanguineo">Tipo sanguineo</label>
                                <input type="text" class="form-control" id="tipoSanguineo" name="tipoSanguineo" value="<?= $estud_tipoSan ?>">
                            </div>
